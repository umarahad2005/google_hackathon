...
abstract class AppLocalizations {
  ...
  /// No description provided for @requestScreenTitle.
  ///
  /// In en, this message translates to:
  /// **'What service do you need?'**
  String get requestScreenTitle;
  ...
  /// No description provided for @requestExampleUrdu.
  ///
  /// In en, this message translates to:
  /// **'مجھے کل صبح G-13 میں AC ٹیکنیشن چاہیے'**
  String get requestExampleUrdu;

  /// No description provided for @requestExampleRomanUrdu.
  ///
  /// In en, this message translates to:
  /// **'Mujhe kal subah G-13 mein AC technician chahiye'**
  String get requestExampleRomanUrdu;

  /// No description provided for @requestExampleEnglish.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @whyThisOne.
  ///
  /// In en, this message translates to:
  /// **'Why this provider?'**
  String get whyThisOne;
  ...
  /// No description provided for @statusReminder.
  ///
  /// In en, this message translates to:
  /// **'Reminder'**
  String get statusReminder;
